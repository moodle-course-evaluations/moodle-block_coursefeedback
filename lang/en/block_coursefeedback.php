...
$string['array_converter_cannot_convert'] = 'Cannot convert {$a->actualtype} to type \'{$a->typehint}\'';
...
$string['invalid_surveypart_backup'] = 'The questionnaire backup file is invalid.';
